...
def main():
    ...
    st.markdown("Widely crawl official reports and news, emphasizing the combination of domestic and international resources to understand public opinion")
    ...
    if start_research:
        ...
        # Since DeepSeek is forced, check relevant API keys
