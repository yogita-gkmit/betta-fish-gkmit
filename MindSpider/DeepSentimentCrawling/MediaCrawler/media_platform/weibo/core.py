...
class WeiboCrawler(AbstractCrawler):
    ...
    async def start(self):
        ...
        async with async_playwright() as playwright:
            ...
            if config.ENABLE_CDP_MODE:
                utils.logger.info("[WeiboCrawler] Launching browser in CDP mode")
                ...
                utils.logger.info("[WeiboCrawler] Launching browser in standard mode")
            ...
            if not await self.wb_client.pong():
                ...
                # After successful login, redirect to mobile website and update cookies on mobile platform
    ...
    async def launch_browser_with_cdp(
        ...
        try:
            ...
            utils.logger.error(f"[WeiboCrawler] CDP mode launch failed, falling back to standard mode: {e}")
