...
class KuaishouCrawler(AbstractCrawler):
    ...
    async def start(self):
        ...
        async with async_playwright() as playwright:
            ...
            if config.ENABLE_CDP_MODE:
                utils.logger.info("[KuaishouCrawler] Launching browser in CDP mode")
                ...
                utils.logger.info("[KuaishouCrawler] Launching browser in standard mode")
    ...
    async def launch_browser_with_cdp(
        ...
        try:
            ...
            utils.logger.error(
                f"[KuaishouCrawler] CDP mode launch failed, falling back to standard mode: {e}"
            )
