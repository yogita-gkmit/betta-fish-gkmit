...
def fix_incomplete_json(text: str) -> str:
    ...
    Returns:
        Fixed JSON text, or empty string if unfixable
    """
...
def update_state_with_search_results(search_results: List[Dict[str, Any]], 
    ...
    """
    Update search results into state
    ...
    if 0 <= paragraph_index < len(state.paragraphs):
        ...
        current_query = ""
        if search_results:
            # Infer query from search results (needs improvement here to get actual query)
