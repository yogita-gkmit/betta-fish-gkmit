...
class Research:
    ...
    search_history: List[Search] = field(default_factory=list)     # List of search history
    latest_summary: str = ""                                       # Latest summary of current paragraph
...
@dataclass
class Paragraph:
    """State of a single paragraph in report"""
